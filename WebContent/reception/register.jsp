		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="studentRegSub"
						action="">
						<div class="form-group">
							<label for="validateName" class="col-sm-2 control-label">真实姓名</label>
							<div class="col-sm-10">
								<input class="form-control" name="studentName" id="validateName"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="form-control" name="studentAccount" id="account"
									type="text" placeholder="考试登录账户" />
							</div>
						</div>
						<div class="form-group">
							<label for="pwd" class="col-sm-2 control-label">考试登录密码</label>
							<div class="col-sm-10">
								<input class="form-control" name="studentPwd" id="pwd"
									type="password" placeholder="考试登录密码" />
							</div>
						</div>
						<div class="form-group">
							<label for="class" class="col-sm-2 control-label">就读班级</label>
							<div class="col-sm-10">
								<select id="classId" class="selectpicker"
									name="classInfo.classId" id="class" data-live-search="true">
