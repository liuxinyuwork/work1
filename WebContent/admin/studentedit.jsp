		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="studentAction"
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input class="form-control" id="studentId" name="studentId"
										type="text" value="${student.studentId }" readonly="readonly"
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<select class="selectpicker" name="classId" id="classId"
									data-live-search="true">
									<option value="${student.classInfo.classId }"
										style="display: none;">${student.classInfo.className }</option>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input class="form-control" id="studentName" name="studentName"
									type="text" value="${student.studentName }" placeholder="学生姓名" />
							</div>
						</div>
						<div class="form-group">
							<label for="studentAccount" class="col-sm-2 control-label">考试登录账户</label>
							<div class="col-sm-5">
								<input class="form-control" id="studentAccount"
									name="studentAccount" type="text"
									value="${student.studentAccount }" readonly="readonly"
									unselectable="on" onfocus="this.blur()" placeholder="学生考试登录账户" />
							</div>
						</div>
						<div class="form-group">
							<label for="studentPwd" class="col-sm-2 control-label">考试登录密码</label>
							<div class="col-sm-5">
								<input class="form-control" id="studentPwd" name="studentPwd"
									type="password" value="${student.studentPwd }"
									placeholder="学生考试登录密码" />
							</div>
						</div>
						<br />
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-4">
								<button id="sub" uUrl="student" aUrl="student/student"
