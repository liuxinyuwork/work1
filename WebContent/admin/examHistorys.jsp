					...
					<c:when test="${not empty historys }">
						<c:forEach items="${historys }" var="history">
							<tr>
								...
								<td><c:if
										test="${history.examScore < history.examPaper.examPaperScore*0.6 }">
								...
								<td>
									<div class="btn-group">
										<a
											href="review?studentId=${history.student.studentId }&examPaperId=${history.examPaper.examPaperId }&score=26&examPaperName=${history.examPaper.examPaperName }&studentName=${history.student.studentName }"
