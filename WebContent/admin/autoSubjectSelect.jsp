...
<%@page
	import="com.taohan.online.exam.service.impl.CourseInfoServiceImpl"%>
			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form"
						action="../autoAddSubject">
						<input type="hidden" value="${param.examPaperId }"
							name="examPaperId" />
						<div class="form-group">
							<label for="subjectSum" class="col-sm-2 control-label">试题数量</label>
							<div class="col-sm-10">
								<input class="form-control" name="subjectSum" id="subjectSum"
									type="text" placeholder="自动生成试题数量" />
							</div>
						</div>
						<div class="form-group">
							<label for="class" class="col-sm-2 control-label">科目</label>
							<div class="col-sm-10">
								<select id="slpk" class="selectpicker" name="courseId"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select id="slpk" class="selectpicker" name="gradeId"
									id="gradeId" data-live-search="true">
									<option value="">不限</option>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select id="slpk" class="selectpicker" name="subjectEasy"
									id="subjectEasy" data-live-search="true">
									<option value="">不限</option>
