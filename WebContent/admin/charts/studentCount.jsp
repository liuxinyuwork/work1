...
<body>
	...
	<div style="width: 100%; height: 100%;">
		<div
			style="width: 100%; height: 100%; float: left; matgin-bottom: 10px;">
			<c:forEach items="${grades }" var="grade">
				<button type="button" class="btn btn-info btn-sm"
					onclick="loadShopLine(${grade.gradeId })">${grade.gradeName }</button>
			</c:forEach>
			<button type="button" class="btn btn-info btn-sm"
				onclick="loadShopLine(-1)">全部</button>
		</div>
		<div id="studentCount"
			style="width: 1000px; height: 400px; float: left; border: 1px solid #E5E5E5;"></div>
	</div>
