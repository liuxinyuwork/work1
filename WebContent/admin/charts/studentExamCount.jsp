...
<body>
	...
	<div style="width: 100%; height: 500px;">
		<div
			style="width: 104px; height: 100%; float: left; margin-left: 10px;">
			<span style="display: none;" id="tid">${sessionScope.loginTeacher.teacherId }</span>
			<strong>描述：</strong>
			<p style="font-size: 12px;">当前图表所描述了本班 所有学生考试信息</p>
			<div>
				<strong>班级学生：</strong>
				<ul id="stusList">
		...
		<div id="stuExamInfo"
			style="margin-left: 100px; width: 750px; height: 400px; float: left; border: 1px solid #E5E5E5;"></div>
	</div>
	<script type="text/javascript">
		//加载本班学生数据
		function loadStus() {
