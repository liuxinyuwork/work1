		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="examPaperAction"
						action="examPaper" method="post">
						<c:if test="${examPaper.examPaperId != null }">
							<div class="form-group">
								<label for="examPaperId" class="col-sm-2 control-label">试卷编号</label>
								<div class="col-sm-3">
									<input class="form-control" id="examPaperId" name="examPaperId"
										type="text" value="${examPaper.examPaperId }"
										readonly="readonly" unselectable='on' onfocus='this.blur()' />
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<select class="selectpicker" name="examPaperEasy"
									id="examPaperEasy" data-live-search="true">
									<c:if test="${examPaper.examPaperEasy == null }">
										<option value="0" style="display: none;">--请选择--</option>
									</c:if>
									<option value="${examPaper.examPaperEasy }"
										style="display: none;">
							...
							<div class="col-sm-5">
								<select class="selectpicker" name="gradeId" id="gradeId"
									...
									<c:if test="${examPaper != null }">
										<option value="${examPaper.grade.gradeId }"
											style="display: none;">${examPaper.grade.gradeName }
										</option>
									</c:if>
									<c:if test="${examPaper == null }">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input class="form-control" id="examPaperName"
									name="examPaperName" type="text"
									value="${examPaper.examPaperName }" placeholder="试卷名称" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<c:if test="${examPaper != null }">
									<input class="form-control" id="subjectNum" name="subjectNum"
										type="text" value="${examPaper.subjectNum }"
										placeholder="试卷中的试题总量" />
								</c:if>
								<c:if test="${examPaper == null }">
									<input class="form-control" id="subjectNum" name="subjectNum"
										type="text" value="0" readonly="readonly" unselectable='on'
										onfocus='this.blur()' />
								</c:if>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<c:if test="${examPaper != null }">
									<input class="form-control" id="examPaperScore"
										name="examPaperScore" type="text"
										value="${examPaper.examPaperScore }" placeholder="试卷总分值" />
								</c:if>
								<c:if test="${examPaper == null }">
									<input class="form-control" id="examPaperScore"
										name="examPaperScore" type="text" value="0"
										readonly="readonly" unselectable='on' onfocus='this.blur()' />
								</c:if>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input class="form-control" id="examPaperTime"
									name="examPaperTime" type="text"
									value="${examPaper.examPaperTime }" placeholder="当前试卷考试时长" />
							</div>
						</div>
						<br />
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-4">
								<button id="sub" uUrl="examPaper" aUrl="examPaper/examPaper"
