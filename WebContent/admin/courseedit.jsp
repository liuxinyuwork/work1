		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="courseAction"
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input class="form-control" id="courseId" name="courseId"
										type="text" value="${course.courseId }" readonly="readonly"
							...
							<div class="col-sm-5">
								<select class="selectpicker" name="gradeId" id="gradeId"
									...
									<c:if test="${course != null }">
										<option value="${course.grade.gradeId }"
											style="display: none;">${course.grade.gradeName }</option>
									</c:if>
									<c:if test="${course == null }">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input class="form-control" id="courseName" name="courseName"
									type="text" value="${course.courseName }" placeholder="学科名称" />
							</div>
						</div>
						<br />
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-4">
								<button id="sub" uUrl="course" aUrl="course/course"
