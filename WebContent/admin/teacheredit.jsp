		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="teacherAction"
						...
						<c:if test="${teacher.teacherId != null }">
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input class="form-control" id="teacherId" name="teacherId"
										type="text" value="${teacher.teacherId }" readonly="readonly"
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<select class="selectpicker" name="adminPower" id="adminPower"
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input class="form-control" id="teacherAccount"
									name="teacherAccount" type="text"
									value="${teacher.teacherAccount }" placeholder="后台登录账户" />
							</div>
						</div>
						<div class="form-group">
							<label for="teacherPwd" class="col-sm-2 control-label">后台登录密码</label>
							<div class="col-sm-5">
								<input class="form-control" id="teacherPwd" name="teacherPwd"
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-4">
								<button id="sub" uUrl="teacher" aUrl="../teacher/teacher"
