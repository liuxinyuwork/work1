...
<link type="text/css" rel="stylesheet"
	href="${path}/js/jeDate/test/jeDate-test.css" />
<link type="text/css" rel="stylesheet"
	href="${path}/js/jeDate/skin/jedate.css" />
		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="examPlanAction"
						action="examPlan" method="post">
						<c:if test="${examPlan.examPlanId != null }">
							<div class="form-group">
								<label for="examPlanId" class="col-sm-2 control-label">记录编号</label>
								<div class="col-sm-3">
									<input class="form-control" id="examPlanId" name="examPlanId"
										type="text" value="${examPlan.examPlanId }"
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<select class="selectpicker" name="clazz.classId" id="classId"
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<select class="selectpicker" name="examPaper.examPaperId"
									id="examPaperId" data-live-search="true">
									<c:if test="${examPlan != null }">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input class="form-control" id="beginTime" name="beginTime"
									id="beginTime" value="${examPlan.beginTime }" />
							</div>
						</div>
						<br />
						<div class="form-group">
