...
<body>
	...
	<form action="subject" id="radio-form">
		<c:if test="${subject != null }">
			<input type="hidden" name="subjectType" id="subjectType-hidden-value"
		...
		<ul id="editor-title" class="nav nav-tabs">
			<c:if test="${subject != null }">
				<c:if test="${subject.subjectType == 0 }">
					<li class="active"><a href="#radioSubject" data-toggle="tab"
						onclick="selectType(this)">单选题</a></li>
					<li><a href="#checkSubject" data-toggle="tab"
						onclick="selectType(this)">多选题</a></li>
					<li><a href="#answerSubject" data-toggle="tab"
						onclick="selectType(this)">简答题</a></li>
				</c:if>
				<c:if test="${subject.subjectType == 1 }">
					<li><a href="#radioSubject" data-toggle="tab"
						onclick="selectType(this)">单选题</a></li>
					<li class="active"><a href="#checkSubject" data-toggle="tab"
						onclick="selectType(this)">多选题</a></li>
					<li><a href="#answerSubject" data-toggle="tab"
						onclick="selectType(this)">简答题</a></li>
				</c:if>
				<c:if test="${subject.subjectType == 2 }">
					...
					<li><a href="#checkSubject" data-toggle="tab"
						onclick="selectType(this)">多选题</a></li>
					<li class="active"><a href="#answerSubject" data-toggle="tab"
						onclick="selectType(this)">简答题</a></li>
				</c:if>
			</c:if>
			<c:if test="${subject == null }">
			...
			<div class="row clearfix">
				...
				<div class="row clearfix">
					<div class="col-md-6 column" style="margin-top: 5px;">
						<div class="form-group">
							<label for="courseId" class="col-sm-5 control-label"
								style="padding-left: 30px;">所属科目</label>
							<div class="col-sm-5" style="padding-left: 22px;">
								<select class="selectpicker" name="course.courseId"
									...
									<c:if test="${subject != null }">
										<option value="${subject.course.courseId }"
											style="display: none;">${subject.course.courseName }
										</option>
									</c:if>
						...
						<div class="form-group">
							...
							<div class="col-sm-5" style="padding-left: 8px;">
								<select class="selectpicker" name="grade.gradeId" id="gradeId"
									data-live-search="true">
									<c:if test="${subject != null }">
										<option value="${subject.grade.gradeId }"
											style="display: none;">${subject.grade.gradeName }</option>
									</c:if>
					...
					<div class="row clearfix">
						<div class="col-md-12 column" style="margin-top: 5px;">
							<div class="form-group">
								<label for="subjectScore" class="col-sm-5 control-label"
									style="padding-left: 43px; width: 21.5%;">题目分值</label>
								<div class="col-sm-5">
							...
							<div class="col-md-12 column" style="margin-top: 5px;">
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-5"
										style="padding-left: 43px; width: 21.5%; margin-left: 0px;">
										<button id="sub" onclick="subjectUpdate()" type="button"
