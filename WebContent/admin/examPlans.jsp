		...
		<table class="table table-striped table-hover table-condensed">
			<thead>
				<tr>
					...
					<th>题目数量</th>
					<th>开考时间</th>
					<th>操作 &emsp; <a type="button"
						onclick="_iframe(0, 'preAddep', 'examPlans')"
						class="btn btn-xs btn-info" target="right">添加</a>
					</th>
				</tr>
			</thead>
			<tbody>
								...
								<td>
									<div class="btn-group">
										<button type="button" class="btn btn-info btn-sm"
											onclick="_iframe(1,'preUpdateep/${plan.examPlanId }', 'examPlans')">修改</button>
										<a href="del/${plan.examPlanId }"
